...
theme.ansi_to_base16_mapping = {0, 8, 11, 10, 13, 14, 12, 5, 3, 8, 11, 10, 13, 14, 12, 7, 9, 15, 1, 2, 4, 6}
---@type table<integer, integer>
theme.base16_to_ansi_mapping = {0, 18, 19, 8, 20, 7, 21, 15, 1, 16, 3, 2, 6, 4, 5, 17}
return theme
